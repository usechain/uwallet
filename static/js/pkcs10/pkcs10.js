(function () {
	...
	function setEngine(name, crypto, subtle)
	{
		...
		{
			//for error Index property setter is not supported
			var index="a"+process.pid
			...
			// noinspection JSUnresolvedVariable
			if(typeof global[index].pkijs === "undefined")
			{
				// noinspection JSUnresolvedVariable
				global[index].pkijs = {};
			}
			...
			{
				// noinspection JSUnresolvedVariable
				if(typeof global[index].pkijs !== "object")
				{
					// noinspection JSUnresolvedVariable
	...
	function getEngine()
	{
		...
		if((typeof process !== "undefined") && ("pid" in process) && (typeof global !== "undefined"))
		{
			...
			try
			{
                var index="a"+process.pid
				// noinspection JSUnresolvedVariable
				_engine = global[index].pkijs.engine;
			}
			catch(ex)
			{
